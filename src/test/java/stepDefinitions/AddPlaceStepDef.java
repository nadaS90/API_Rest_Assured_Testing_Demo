...
public class AddPlaceStepDef extends Util {

    RequestSpecification requestSpec;
    ResponseSpecification respinseSpec;
    Response response;
    ...
    public void user_calls_with_http_request(String resource, String method)
    {
        ...
        respinseSpec = new ResponseSpecBuilder().expectStatusCode(200).expectContentType(ContentType.JSON).build();
